...
- Interview me in detail using the AskUserQuestionTool about literally anything (technical implementation, UI/UX, concerns, tradeoffs, etc). But make sure they are very in-depth not obvious.
